const FilterBar = ({ cars, filters, onChange }) => {
  ...
  return (
    <div className="mb-10 rounded-luxury bg-black p-6 shadow-editorial">
      <div className="mb-5 flex items-center justify-between gap-4">
        <div>
          <p className="eyebrow text-[10px] text-gray-400">Filter Armada</p>
          <h2 className="mt-2 text-lg font-extrabold text-white">Temukan mobil yang sesuai</h2>
        </div>
      </div>
